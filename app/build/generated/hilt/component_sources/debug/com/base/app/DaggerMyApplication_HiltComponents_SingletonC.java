...
import com.base.app.ui.detail.DetailViewModel;
import com.base.app.ui.detail.DetailViewModel_HiltModules;
import com.base.app.ui.home.HomeViewModel;
import com.base.app.ui.home.HomeViewModel_HiltModules;
...
public final class DaggerMyApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MyApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(2).put(LazyClassKeyProvider.com_base_app_ui_detail_DetailViewModel, DetailViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_base_app_ui_home_HomeViewModel, HomeViewModel_HiltModules.KeyModule.provide()).build());
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_base_app_ui_detail_DetailViewModel = "com.base.app.ui.detail.DetailViewModel";

      static String com_base_app_ui_home_HomeViewModel = "com.base.app.ui.home.HomeViewModel";

      @KeepFieldType
      DetailViewModel com_base_app_ui_detail_DetailViewModel2;

      @KeepFieldType
      HomeViewModel com_base_app_ui_home_HomeViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends MyApplication_HiltComponents.ViewModelC {
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(2).put(LazyClassKeyProvider.com_base_app_ui_detail_DetailViewModel, ((Provider) detailViewModelProvider)).put(LazyClassKeyProvider.com_base_app_ui_home_HomeViewModel, ((Provider) homeViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.base.app.ui.detail.DetailViewModel 
          return (T) new DetailViewModel();

          case 1: // com.base.app.ui.home.HomeViewModel 
